      ...
      return (searchForm = (
        <form className="nav-bar-search-form" onSubmit={this.handleSubmit}>
          ...
          <input
            ...
            />
          <button id="nav-search-button" onSubmit={this.handleSubmit}>
            Search
          </button>
        </form>
      ));
  ...
  render() {
    const theModal = (
      <Modal
        ...
        contentLabel="Modal"
      >
        <div className={this.state.whichClass}>{this.state.formType}</div>
      </Modal>
    );
      ...
      <div className="navbar">
        <span>
          <Link to="/">
            <img
              id="logo"
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOchZVtVc4mzEfOS7jg43BPZQVeGc7Ea6rqaP8bSdwKg_oDS60"
            />
          </Link>
        </span>
        {this.correctPath()}
