...
Review.create( { author_id: user10.id, spot_id: spot5.id, body: 'It was ok. I really enjoyed the hosts though, and they kept the place very clean.' } )
...
Review.create( { author_id: user10.id, spot_id: spot1.id, body: '' } )
...
Review.create( { author_id: user6.id, spot_id: spot2.id, body: '' } )
