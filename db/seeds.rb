...
ActiveRecord::Base.transaction do
  ...
  spot1 = Spot.create( { owner_id: user1.id, lat: 33.874853, long: -117.899078,
    description: 'This house near Disneyland has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
  ...
  spot12 = Spot.create( { owner_id: user1.id, lat: 34.064525, long: -118.272600, description: 'This house near Universal Studios has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1502672023488-70e25813eb80?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=4f890a0c2f29ada0a8dfc182dbfc0912&auto=format&fit=crop&w=959&q=80',
    price: 120, guests: 2, bedrooms: 2, bathrooms: 2, title: 'Gorgeous house in sunny California!' })
  spot13 = Spot.create!( { owner_id: user2.id, lat: 34.077008, long: -118.364831,description: 'This house near Universal Studios has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1511702771955-42b52e1cd168?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=0b8ce1412e0f8646fa9f794963ab897e&auto=format&fit=crop&w=1050&q=80',
    price: 23, guests: 4, bedrooms: 3, bathrooms: 2, title: 'Relaxing sunny apartment' })
  spot14 = Spot.create( { owner_id: user3.id, lat: 34.096912, long: -118.282434, description: 'This house near Universal Studios has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1505843694770-3461f546bd8f?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=db17657261e1b3262e360cc96358cb17&auto=format&fit=crop&w=1190&q=80',
    price: 184, guests: 3, bedrooms: 2, bathrooms: 1, title: 'Come stay at our home!' })
  spot15 = Spot.create( { owner_id: user4.id, lat: 34.128179, long: -118.257715, description: 'This house near Universal Studios has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1505873242700-f289a29e1e0f?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=91b874ce453385d8867cc98ee582fee3&auto=format&fit=crop&w=1055&q=80',
    price: 158, guests: 4, bedrooms: 4, bathrooms: 4, title: 'Home that oozes comfort' })
  spot16 = Spot.create( { owner_id: user5.id, lat: 34.143240, long: -118.297540, description:'This house near Universal Studios has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1489171078254-c3365d6e359f?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=fe3391048aa6a5e7e0675015330416e8&auto=format&fit=crop&w=1189&q=80',
    price: 67, guests: 2, bedrooms: 1, bathrooms: 1, title: 'Cute apartment near Universal Studios!' })
  spot17 = Spot.create( { owner_id: user6.id, lat: 34.135852, long: -118.373414, description: 'This house near Universal Studios has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=eef2ec2eb92ca06d154df5147fbae1fe&auto=format&fit=crop&w=1047&q=80',
    price: 240, guests: 4, bedrooms: 2, bathrooms: 1, title: 'Our house is perfect for you!' })
  spot18 = Spot.create( { owner_id: user7.id, lat: 34.123347, long: -118.411867, description: 'This house near Universal Studios has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1432303492674-642e9d0944b2?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=e8ee660baa348701771b605ad2d15154&auto=format&fit=crop&w=1053&q=80',
    price: 397, guests: 5, bedrooms: 3, bathrooms: 4, title: 'Trendy home perfect for relaxing' })
  spot19 = Spot.create( { owner_id: user8.id, lat: 34.169093, long: -118.327409, description: 'This house near Universal Studios has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1464146072230-91cabc968266?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=81fa6e2c81cf9e4e1b7c51f18eef6eb0&auto=format&fit=crop&w=1050&q=80',
    price: 500, guests: 7, bedrooms: 5, bathrooms: 6, title: 'Fabulous French-inspired Château' })
  spot20 = Spot.create( { owner_id: user9.id, lat: 34.173638, long: -118.364831, description: 'This house near Universal Studios has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1495754149474-e54c07932677?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=36797b09c9261d94250ceb3425cab2fa&auto=format&fit=crop&w=1050&q=80',
    price: 98, guests: 3, bedrooms: 5, bathrooms: 2, title: 'Beautiful home in North Hollywood!' })
  spot21 = Spot.create( { owner_id: user10.id, lat: 34.173917, long: -118.418969, description: 'This house near Universal Studios has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1493210977798-4f655ac200a9?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=ba16f7a4d01403185df43e9c56f9edbe&auto=format&fit=crop&w=862&q=80',
    price: 980, guests: 2, bedrooms: 1, bathrooms: 2, title: 'Eccentric downtown apartment' })
  spot22 = Spot.create( { owner_id: user11.id, lat: 34.411372, long: -118.589105, description: 'This house near Six Flags has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1502672023488-70e25813eb80?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=4f890a0c2f29ada0a8dfc182dbfc0912&auto=format&fit=crop&w=959&q=80',
    price: 120, guests: 2, bedrooms: 2, bathrooms: 2, title: 'Gorgeous house in sunny California!' })
  spot23 = Spot.create( { owner_id: user1.id, lat: 34.415904, long: -118.581895, description: 'This house near Six Flags has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1511702771955-42b52e1cd168?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=0b8ce1412e0f8646fa9f794963ab897e&auto=format&fit=crop&w=1050&q=80',
    price: 23, guests: 4, bedrooms: 3, bathrooms: 2, title: 'Relaxing sunny apartment' })
  spot24 = Spot.create( { owner_id: user2.id, lat: 34.411443, long: -118.568677, description: 'This house near Six Flags has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1505843694770-3461f546bd8f?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=db17657261e1b3262e360cc96358cb17&auto=format&fit=crop&w=1190&q=80',
    price: 184, guests: 3, bedrooms: 2, bathrooms: 1, title: 'Come stay at our home!' })
  spot25 = Spot.create( { owner_id: user4.id, lat: 34.436577, long: -118.592109, description: 'This house near Six Flags has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1505873242700-f289a29e1e0f?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=91b874ce453385d8867cc98ee582fee3&auto=format&fit=crop&w=1055&q=80',
    price: 158, guests: 4, bedrooms: 4, bathrooms: 4, title: 'Home that oozes comfort' })
  spot26 = Spot.create( { owner_id: user5.id, lat: 34.443797, long: -118.570823, description: 'This house near Six Flags has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=eef2ec2eb92ca06d154df5147fbae1fe&auto=format&fit=crop&w=1047&q=80',
    price: 240, guests: 4, bedrooms: 2, bathrooms: 1, title: 'Our house is perfect for you!' })
  spot27 = Spot.create( { owner_id: user6.id, lat: 34.429073, long: -118.568677, description: 'This house near Six Flags has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1432303492674-642e9d0944b2?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=e8ee660baa348701771b605ad2d15154&auto=format&fit=crop&w=1053&q=80',
    price: 397, guests: 5, bedrooms: 3, bathrooms: 4, title: 'Trendy home perfect for relaxing' })
  spot28 = Spot.create( { owner_id: user7.id, lat: 34.423480, long: -118.566102, description: 'This house near Six Flags has several bedrooms, several bathrooms, is extremely large and family friendly! It is the perfect home to relax and take a vacation from the chaos and hectic schedule of your every day life. Come stay at our lovely home and you will not be disappointed!',
    image_url: 'https://images.unsplash.com/photo-1464146072230-91cabc968266?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=81fa6e2c81cf9e4e1b7c51f18eef6eb0&auto=format&fit=crop&w=1050&q=80',
    price: 500, guests: 7, bedrooms: 5, bathrooms: 6, title: 'Fabulous French-inspired Château' })
  ...
  Review.delete_all
  Review.create( { author_id: user6.id, spot_id: spot2.id, body: 'This place was great! Would definitely stay again.' } )
  Review.create( { author_id: user4.id, spot_id: spot29.id, body: 'This place was great! Would definitely stay again.' } )
  Review.create( { author_id: user8.id, spot_id: spot2.id, body: 'It was ok. I really enjoyed the hosts though, and they kept the place very clean.' } )
  Review.create( { author_id: user1.id, spot_id: spot2.id, body: "I didn't like it." } )
  Review.create( { author_id: user6.id, spot_id: spot3.id, body: 'It was ok. I really enjoyed the hosts though, and they kept the place very clean.' } )
  Review.create( { author_id: user4.id, spot_id: spot4.id, body: 'This place was great! Would definitely stay again.' } )
  Review.create( { author_id: user10.id, spot_id: spot5.id, body: 'It was ok. I really enjoyed the hosts though (thanks Kendall!), and they kept the place very clean.' } )
  Review.create( { author_id: user8.id, spot_id: spot7.id, body: 'This place was great! Would definitely stay again.' } )
  Review.create( { author_id: user9.id, spot_id: spot9.id, body: 'Gorgeous!! Would stay again in a heartbeat. Weather was perfect, hosts were tremondous, recommend to all!' } )
  Review.create( { author_id: user2.id, spot_id: spot11.id, body: 'This place was great! Would definitely stay again.' } )
  Review.create( { author_id: user1.id, spot_id: spot11.id, body: 'Gorgeous!! Would stay again in a heartbeat. Weather was perfect, hosts were tremondous, recommend to all!' } )
  Review.create( { author_id: user3.id, spot_id: spot12.id, body: 'It was ok. I really enjoyed the hosts though, and they kept the place very clean.' } )
  Review.create( { author_id: user11.id, spot_id: spot14.id, body: 'This place was great! Would definitely stay again.' } )
  Review.create( { author_id: user6.id, spot_id: spot16.id, body: 'It was ok. I really enjoyed the hosts though, and they kept the place very clean.' } )
  Review.create( { author_id: user7.id, spot_id: spot18.id, body: 'This place was great! Would definitely stay again.' } )
  Review.create( { author_id: user10.id, spot_id: spot20.id, body: 'This place was great! Would definitely stay again.' } )
  Review.create( { author_id: user1.id, spot_id: spot15.id, body: 'Gorgeous!! Would stay again in a heartbeat. Weather was perfect, hosts were tremondous, recommend to all!' } )
  Review.create( { author_id: user3.id, spot_id: spot3.id, body: 'This place was great! Would definitely stay again.' } )
  Review.create( { author_id: user5.id, spot_id: spot3.id, body: "I didn't like it." } )
  Review.create( { author_id: user7.id, spot_id: spot4.id, body: "I didn't like it." } )
  Review.create( { author_id: user9.id, spot_id: spot27.id, body: 'It was ok. I really enjoyed the hosts though, and they kept the place very clean.' } )
  Review.create( { author_id: user2.id, spot_id: spot7.id, body: "I didn't like it." } )
  Review.create( { author_id: user4.id, spot_id: spot9.id, body: "I didn't like it." } )
  Review.create( { author_id: user6.id, spot_id: spot10.id, body: 'This place was great! Would definitely stay again.' } )
  Review.create( { author_id: user8.id, spot_id: spot10.id, body: 'It was ok. I really enjoyed the hosts though, and they kept the place very clean.' } )
  Review.create( { author_id: user10.id, spot_id: spot1.id, body: 'Wonderful place!!! Quiet, peaceful, host was very accommodating. Thanks Courtney!' } )
  Review.create( { author_id: user3.id, spot_id: spot1.id, body: 'Gorgeous!! Would stay again in a heartbeat. Weather was perfect, hosts were tremondous, recommend to all!' } )
  Review.create( { author_id: user7.id, spot_id: spot1.id, body: 'This place was great! Would definitely stay again.' } )
  Review.create( { author_id: user11.id, spot_id: spot2.id, body: 'Gorgeous!! Would stay again in a heartbeat. Weather was perfect, hosts were tremondous, recommend to all!' } )
  Review.create( { author_id: user6.id, spot_id: spot2.id, body: 'HALF A STAR. MAYBE. Smells like wet dog.' } )
